/* ═══════════════════════════════════════════════════════════════════════════
   FightMarketing — 3D Scheenbeschermer Viewer (Three.js)
   ═══════════════════════════════════════════════════════════════════════════
   Kopie van client/public/configurator/js/scene3d.js (bokshandschoen) — zelfde
   generieke renderer, hier toegepast op de scheenbeschermer. Los bestand
   (zelfde patroon als de T-shirt-configurator) zodat wijzigingen hier NOOIT
   de handschoen-configurator kunnen raken.
...
export function createShinguardViewer(canvas, opts = {}) {
  // Geen model-profile.js/fallback nodig — er is maar één scheenbeschermer-
  // model, configurator.js geeft het profiel altijd expliciet mee.
